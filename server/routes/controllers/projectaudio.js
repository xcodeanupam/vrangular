...
var projectaudio_1 = require("../models/projectaudio");

var ProjectaudioCtrl = (function (_super) {
    __extends(ProjectaudioCtrl, _super);
    function ProjectaudioCtrl() {
    ...
    return ProjectaudioCtrl;
})(base_1.default, projectaudio_1.default);
exports.default = ProjectaudioCtrl;
